...
class PatientRegisterTestCase(TestCase):
    def setUp(self):
        # Définir l'URL de la vue d'inscription des patients
        self.register_url = '/patient-register/'

        # Préparer les données de l'utilisateur pour le test d'inscription
        self.user_data = {
    ...
    def test_create(self):
        # Envoyer une requête POST à l'URL d'inscription avec les données de l'utilisateur
    ...
    def test_str(self):
        # Créer un utilisateur avec un email et un mot de passe
        user = User.objects.create(email='patient10@gmail.com', password='testpassword')

        # Vérifier que la méthode __str__ de l'utilisateur renvoie bien l'email de l'utilisateur
